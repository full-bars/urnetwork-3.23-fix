...
- PRIVACY SCRUB is a hard gate before Repo C: no real usernames (klets, mesocyclone,
...
- Repo A: /home/klets/ur/urnetwork-3.23-fix — active development, PR #465 open.
- Repo B: full-bars/meso-miner — NOT cloned locally yet (verify path; may live
  under /home/klets/ur/full-bars/meso-miner or a separate checkout). Mirror edits
...
4. PRIVACY SCRUB gate: grep the proposed C commit for
   `klets|mesocyclone|/home/|C:\\Users|192\.168|10\.|172\.16|100\.` etc.
