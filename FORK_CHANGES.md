...
**Change**:
- New `proxyURLGiveUpRetryDelay(giveUpCount)` computes escalating delay (cycle 1=15m, 2=30m, 3=1h; capped at 24h with 20% jitter); eviction at cycle 4+ means only cycles 1-3 execute in practice
